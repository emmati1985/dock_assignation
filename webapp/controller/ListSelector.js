sap.ui.define([
		...
		return BaseObject.extend("dockass.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias dockass.model.ListSelector
			 */
			 ...
			 * @return {dockass.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
