sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("dockass/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("dockass.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["dockass/localService/mockserver"], function (mockserver) {
